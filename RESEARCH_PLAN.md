...
| **N-CMAPSS** (NASA, 2021) | Primary #2 — strongly recommended | Successor with realistic flight profiles, 47 channels, DS01–DS08. Much larger; ideal for the *high*-data end of your sweep, which C-MAPSS (100 units) can't provide. |
